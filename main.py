...
# Game Title
pygame.display.set_caption("Snake By Om Kumar")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to Snakes", black, 230, 100)
        text_screen("Press space to play", black, 210, 130)
        text_screen("This game is made by Om Kumar", black, 180, 160)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Score: " + str(score) + "  Hiscore: " + str(hiscore),
                        red, 5, 5)
